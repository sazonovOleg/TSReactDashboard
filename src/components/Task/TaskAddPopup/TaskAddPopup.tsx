            ...
            <div className="task-popup-container">
                ...
                <div className="form">
                    <div className="form-col">
                        ...
                        <input onChange={(event => setTitle(event.target.value))} value={taskTitle} type="text" className="form-input form-input--title"/>
                    </div>
                    <div className="form-col">
                        <h3 className="form-title">
                            Description
                        </h3>
                        <textarea onChange={(event => setDescription(event.target.value))}  value={description} className="form-input form-input--textarea"/>
                    </div>
                    <button disabled={!Boolean(taskTitle) || !Boolean(description)} onClick={() => {
